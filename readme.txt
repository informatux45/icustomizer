...
[DEV By INFORMATUX](https://dev.informatux.com/) / [Documentation](https://dev.informatux.com/).
...
3. icustomizer custom css front
4. icustomizer custom css admin
5. icustomizer custom js front
6. icustomizer wp editor behaviors
7. icustomizer wp admin login
8. icustomizer security
...
== Upgrade Notice ==
Pensez à mettre à jour votre plugin... question de sécurité et de nouveautés ;-)
